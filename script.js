...
function createProductCardHTML(prod) {
    ...
    // The card is created with the .animate-on-scroll class
    return `
...
function initIndexPage() {
    ...
    function renderCategoryCarousels(products) {
        ...
        CATEGORIES_TO_DISPLAY.forEach(categoryName => {
            ...
            // Observe the newly added carousel wrapper for animation
            ...
            // Observe the newly added product cards inside the carousel
    ...
    function renderFeaturedProducts(products) {
        ...
        // After inserting, find the new cards and observe them
...
function initCatalogPage() {
    // Logic for catalog page will go here
}

// --- PRODUCT DETAIL PAGE ---
function initProductDetailPage() {
    // Logic for product detail page will go here
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Observe all static elements with the animation class
