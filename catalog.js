...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function runFilterAndSort() {
        ...
        // =================================================================================
        // === ИЗМЕНЕНИЕ ЗДЕСЬ: Обновляем заголовок вкладки для улучшения UX ===
        // =================================================================================
        // "Турбо-скрипт" в HTML обновляет теги только при первой загрузке.
        // Этот код обновляет заголовок каждый раз, когда пользователь меняет фильтры.
