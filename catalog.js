...
// ===============================================================
// =================== ИСПРАВЛЕННЫЙ MAIN CATALOG SCRIPT ==========
// ===============================================================
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchAndRenderProducts(isLoadMore = false) {
        ...
        try {
            // **ИСПРАВЛЕНИЕ ЗДЕСЬ: Собираем все условия запроса в один массив**
            ...
            // **ИСПРАВЛЕНИЕ ЗДЕСЬ: Создаем финальный запрос ОДИН РАЗ со всеми условиями**
            ...
            card.innerHTML = `
                ...
                <div class="product-info">
                    ...
                    <div class="product-price">
                        <div class="price">$${prod.price ? prod.price.toFixed(2) : 'N/A'}</div>
